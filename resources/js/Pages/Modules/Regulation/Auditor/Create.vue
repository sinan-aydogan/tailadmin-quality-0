<template>
  <app-layout :action-buttons="true">
    <!--Header-->
    <template #header>Create Auditor Staff</template>
    <template #subHeader>You can new auditor staff for the audit firm</template>
    <!--Action Buttons-->
    <template #action-buttons>;
      <t-action-buttons-create model="auditor"/>
    </template>
    <template #default>
