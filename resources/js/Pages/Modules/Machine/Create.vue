...
export default {
  ...
  methods: {
    ...
    save() {
      ...
      this.form.code === null ? this.$set(this.error, 'code', 'Code is required') :
        this.$delete(this.error, 'code');
      this.form.model === null ? this.$set(this.error, 'model', 'Model is required') :
        this.$delete(this.error, 'model');
      this.form.manufacturer === null ? this.$set(this.error, 'manufacturer',
          'Manufacturer is required') :
        this.$delete(this.error, 'manufacturer');
