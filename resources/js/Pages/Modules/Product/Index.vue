            ...
            >
                ...
                <template #name="{props}">
                    <div class="flex flex-row whitespace-nowrap items-center gap-2">
                        <div v-if="props.photo"
                             class="flex items-center justify-center rounded-lg overflow-hidden w-12 h-12 gap-2 bg-gray-200 bg-opacity-50">
                ...
                <!--Standard-->
                <template #standards="{props}">
                    <div class="flex flex-wrap gap-2">
                        <t-popover
                            position="left"
                            v-for="(item,index) in props.standards"
                            :key="index"
                            class="bg-white py-1 px-2 rounded-md border"
                        >
                ...
                <template #is_certified="{props}">
                    <t-badge :color="is_certified.find( s => s.id === props.is_certified ).color">
                        {{ is_certified.find( s => s.id === props.is_certified ).name }}
                    </t-badge>
                </template>
            </t-table>
        </template>
    ...
    data() {
        return {
            tableHeaders: [
                ...
                {label: 'Related Standards', key: 'standards', align: 'left'},
