  ...
  <app-layout>
    ...
    <template #default>
      <t-form-content>
        ...
        >
          <t-input-group class="col-span-12 md:col-span-6" label="Timer" label-for="timer">
...
export default {
  ...
  data() {
    return {
      ...
      sampleCode: {
        html:
            '<t-alert color="solid-indigo" :border="true" :closeable="true" :radius="5" :timer="500" position="rb">\n' +
